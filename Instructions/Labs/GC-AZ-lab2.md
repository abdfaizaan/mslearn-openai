...
1. Click on **Open in playground** . This will direct you to the playground interface where you can interact with the model.
...
1. In the CloudShell code editor, open the configuration file for your app. Choose the file based on the language you're using:
   ...
   - For **C#**: Open the appsettings.json file by running the following command:
    ...
    - For Python: Open the .env file by running:
...
1. When prompted, **Enter a prompt to request an image** for the image you want to generate. For example, you could enter:
